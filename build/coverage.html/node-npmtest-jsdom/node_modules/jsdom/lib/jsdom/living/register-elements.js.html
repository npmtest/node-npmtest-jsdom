...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jsdom/node_modules/jsdom/lib/jsdom/living/register-elements.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jsdom/node_modules/jsdom/lib/jsdom/living/register-elements.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jsdom/node_modules/jsdom/lib/jsdom/living/</a> &#187; register-elements.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  for (const interfaceName of Object.keys(mappings)) {</span>
<span class="cstat-no" title="statement not covered" >    const file = mappings[interfaceName].file;</span>
<span class="cstat-no" title="statement not covered" >    const tags = mappings[interfaceName].tags;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    core[interfaceName] = file.interface;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (const tagName of tags) {</span>
<span class="cstat-no" title="statement not covered" >      DocumentImpl.implementation.prototype._elementBuilders[tagName] = (document, elName) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        return file.create([], {</span>
          core,
